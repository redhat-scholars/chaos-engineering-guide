...
image::images/jaeger-query.png[Jaeger - Query, 800]
...
image::images/jaeger-trace-2spans-view.png[Jaeger - Traces View, 800]
...
image::images/che-buildcatalog.png[Che - Build Catalog Service, 500]
...
image::images/jaeger-trace-fixed-detail-view.png[Jaeger - Trace Detail View, 700]
