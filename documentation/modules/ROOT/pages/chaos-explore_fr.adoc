...
A l'intérieur de l'espace de nom ** 'chaos-engineering{USER_ID}', nous voyons 3 parties
...
image::travels-demo-design.png[travel-demo-design - Démo de voyage Projet déployé par Argo CD , 800]
...
Dans le {KIALI_URL}[Kiali Console^, role='params-link'], de la vue **'Services'**, `*cliquez sur le service de contrôle 'Actions' `
...
image:kiali-control-add-rule.png[Kiali - Contrôle Ajouter la règle , 500]
...
image:kiali-control-create-ingress.png[Kiali - Contrôle Créer l'entrée , 500]
