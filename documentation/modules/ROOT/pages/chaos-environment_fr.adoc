...
`*Enter your username and password (user{USER_ID}/{OPENSHIFT_PASSWORD})*` et
...
`*Select the 'Developer View' then your 'chaos-engineering{USER_ID}'*` à prendre à la page d'aperçu du projet
...
Pour déployer l'application, `*click on your 'chaos-engineering{USER_ID}' application box then, click on 'Sync > Synchronize'*`.
