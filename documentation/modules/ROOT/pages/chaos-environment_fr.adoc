...
`*Enter your username and password (userTTKN1043)*` et
...
`*Select the 'Developer View' then your 'chaos-engineeringTTKN1044'*` à prendre à la page d'aperçu du projet
...
Puis `*log in as userTTKN1046*`. Une fois terminé, vous serez redirigé vers la page suivante qui liste les **Argo CD Applications**.
...
Pour déployer l'application, `*click on your 'chaos-engineeringTTKN1050' application box then, click on 'Sync > Synchronize'*`.
...
sélectionnez le `**chaos-engineeringTTKN1052**` à la page d'aperçu du projet.
