...
`*Enter your username and password (userTTKN1040)*` et
...
`*Select the 'Developer View' then your 'chaos-engineeringTTKN1041'*` à prendre à la page d'aperçu du projet
...
Puis `*log in as userTTKN1043*`. Une fois terminé, vous serez redirigé vers la page suivante qui liste les **Argo CD Applications**.
...
Pour déployer l'application, `*click on your 'chaos-engineeringTTKN1047' application box then, click on 'Sync > Synchronize'*`.
...
sélectionnez le `**chaos-engineeringTTKN1049**` à la page d'aperçu du projet.
