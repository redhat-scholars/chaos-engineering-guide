...
Puis s'identifier comme {USER_ID}/{OPENSHIFT_PASSWORD}. Une fois terminé, vous serez redirigé vers la page suivante qui liste les **Argo CD Applications**.
...
sélectionnez la page d'aperçu du projet *chaos-engineering{USER_ID}*.
