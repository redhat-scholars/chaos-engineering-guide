...
[sidebar]
--
image::images/kiali.png[Kiali, 400]
...
image::images/kiali-graph.png[Kiali - Graph, 700]
...
image::images/kiali-4xx.png[Kiali - 4xx, 300]
...
image::images/gateway-cart-missing.png[Gateway Error, 700]
...
image::images/containerization-process.png[Quarkus - Container, 700]
...
image::images/console-cart.png[Openshift Console Cart, 800]
...
image::images/che-buildgateway.png[Che - Build Gateway Service, 500]
...
image::images/gateway-cart-fixed.png[Gateway Fixed, 700]
