...
= Chaos Experiment 2: Injecting Errors

_XX MINUTE PRACTICE_

For this second experiment, we will test the following hypothesis:
...
image::kiali-error-fault-overview.png[Kiali - Latency Fault Overview,900]

All services, except for the 'discounts' service, performs very well without any errors (100%). You could increase the pourcentage of error injection but you will discover that the application is resilient. So your hypothesis is validated.
