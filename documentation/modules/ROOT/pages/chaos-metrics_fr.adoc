...
[source,promql,subs="TTKN1202",role=copypaste]
. PromQL
---
...
[source,promql,subs="TTKN1203",role=copypaste]
. PromQL
---
...
[source,promql,subs="TTKN1206",role=copypaste]
. PromQL
---
**augmentation(**istio_requests_total{reporter="source", namespace="chaos-engineering{USER_ID}"}**[1m])**
---
...
[source,promql,subs="TTKN1208",role=copypaste]
. PromQL
---
...
[source,promql,subs="TTKN1213",role=copypaste]
. PromQL
---
...
*<MISSING TTKN12494>xx et 5xx = Total des requêtes dans Erreur HTTP 4xx et 5xx
...
* [Pink]  Taux de réussite = > pour identifier l'erreur HTTP WHEN survenant dans l'appel de service
