...
Puis, `*log in with OpenShift as 'userTTKN1257'*`
...
[WARNING]
====
Si vous recevez une erreur mentionnant **"Un tableau de bord dans ce dossier avec le même nom existe déjà"**, `*please add 'userTTKN1264' in the name*`.
...
*<MISSING TTKN12914>xx et 5xx = Total des requêtes dans Erreur HTTP 4xx et 5xx
