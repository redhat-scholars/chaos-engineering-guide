...
Puis, `*log in with OpenShift as 'userTTKN1264'*`
...
[WARNING]
====
Si vous recevez une erreur mentionnant **"Un tableau de bord dans ce dossier avec le même nom existe déjà"**, `*please add 'userTTKN1271' in the name*`.
...
*<MISSING TTKN12984>xx et 5xx = Total des requêtes dans Erreur HTTP 4xx et 5xx
