...
Puis, `*log in with OpenShift as 'userTTKN1303/TTKN1304'*`
...
[WARNING]
====
Si vous recevez une erreur mentionnant **"Un tableau de bord dans ce dossier avec le même nom existe déjà"**, `*please add 'userTTKN1312' in the name*`.
...
*<MISSING TTKN13394>xx et 5xx = Total des requêtes dans Erreur HTTP 4xx et 5xx
