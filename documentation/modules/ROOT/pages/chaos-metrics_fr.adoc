...
* [Red] one bloc de sélection de filtres dans lequel nous sélectionnons un espace nom  [Pink] ici chaos-engineering{USER_ID} et un service  [Cyan]  de la demande de voyage
...
* [Cyan] liste de tous les noms de services disponibles dans l'espace de nom chaos-engineering{USER_ID}
